...
export interface CONTRACT_AUTHORIZEOutput {
  transactionId: String_71;
  totalAmount: Number_6;
  timestamp: Number_7;
}
 ...
 */
export type NumberNull = Number_9 | Null_62;
export type Number_9 = number;
export type Null_62 = null;
export type String_81 =
  | "openai:gpt-4.1-mini"
  | "openai:gpt-oss-120b"
  | "openai:gpt-oss-20b"
 ...
 */
export type String_87 = "PUBLIC" | "WORKSPACE" | "PRIVATE";
...
export interface AGENTS_CREATEInput {
   ...
   */
  model?: String_81 | String_82;
  memory?: Object_6;
  views?: Array_4;
  visibility?: String_87;
  /**
 ...
 * Maximum number of tokens the agent can use, defaults to 8192
 */
export type NumberNull_1 = Number_13 | Null_65;
export type Number_13 = number;
export type Null_65 = null;
export type String_97 =
  | "openai:gpt-4.1-mini"
  | "openai:gpt-oss-120b"
  | "openai:gpt-oss-20b"
  | "google:gemini-2.5-pro"
 ...
 * Visibility of the agent
 */
export type String_103 = "PUBLIC" | "WORKSPACE" | "PRIVATE";
...
export interface Object_9 {
   ...
   * Model to use for the agent - either a well-known model ID or UUID for BYOK models
   */
  model?: String_97 | String_98;
  memory?: Object_11;
  views: Array_7;
  visibility: String_103;
  /**
   * Access control by role
   */
  access?:
 ...
 * Tool names for a given integrationId. Add an empty array for enabling all tools of this integration. This should prevent bugs
 */
export type Array_8 = String_111[];
/**
 * Maximum number of steps the agent can take, defaults to 7
 */
 ...
 * Maximum number of tokens the agent can use, defaults to 8192
 */
export type NumberNull_2 = Number_17 | Null_68;
export type Number_17 = number;
export type Null_68 = null;
export type String_112 =
  | "openai:gpt-4.1-mini"
  | "openai:gpt-oss-120b"
  | "openai:gpt-oss-20b"
  | "google:gemini-2.5-pro"
 ...
 * Visibility of the agent
 */
export type String_118 = "PUBLIC" | "WORKSPACE" | "PRIVATE";
...
export interface Object_14 {
   ...
   * Model to use for the agent - either a well-known model ID or UUID for BYOK models
   */
  model?: String_112 | String_113;
  memory?: Object_16;
  views?: Array_9;
  visibility?: String_118;
  /**
   * Access control by role
   */
  access?:
...
export interface Object_16 {
  discriminator?: String_114;
  last_messages?: Number_18;
  semantic_recall?: Boolean_6;
  working_memory?: Object_17;
}
/**
 * Working memory to use for the agent
 */
...
export type String_121 = "user" | "assistant" | "system";
...
export type Array_12 = String_128[];
...
export type String_133 = "user" | "assistant" | "system";
...
export type Array_15 = String_140[];
...
export interface Object_27 {
  promptTokens: Number_27;
  completionTokens: Number_28;
  totalTokens: Number_29;
 ...
 */
export type Array_16 = String_144[];
...
export type String_148 = "is_integration";
...
export type String_158 = "is_integration";
export type String_159 = string;
/**
 * Policies for the API key
 */
export type Array_18 = Object_31[];
...
export interface Object_31 {
  effect: String_156;
  resource: String_157;
  matchCondition?: Object_32;
}
export interface Object_32 {
  resource: String_158;
  integrationId: String_159;
}
...
export interface CHANNELS_CREATEInput {
  discriminator: String_161;
  integrationId: String_162;
  agentId?: String_163;
  name?: String_164;
}
...
export interface CREATE_CHECKOUT_SESSIONInput {
  amountUSDCents: Number_30;
  successUrl: String_171;
  cancelUrl: String_172;
}
 ...
 */
export type Array_19 = String_175[];
/**
...
export type String_177 = "success" | "error" | "skipped";
export type String_178 = string;
export type Array_20 = Object_33[];
export type Number_34 = number;
export type Number_35 = number;

export interface DATABASES_MIGRATEOutput {
  success: Boolean_11;
  migratedTables: Array_20;
  totalRowsMigrated: Number_34;
  executionTimeMs: Number_35;
}
export interface Object_33 {
  tableName: String_176;
  rowCount: Number_33;
  status: String_177;
  error?: String_178;
}
...
export interface Object_35 {
  ...
  changes?: Number_36;
  duration?: Number_37;
  last_row_id?: Number_38;
  rows_read?: Number_39;
  rows_written?: Number_40;
  served_by_primary?: Boolean_14;
  served_by_region?: String_180;
  size_after?: Number_41;
  timings?: Object_36;
}
export interface Object_36 {
  sql_duration_ms?: Number_42;
}
...
export interface DECO_INTEGRATION_OAUTH_STARTInput {
  appName: String_185;
  returnUrl: String_186;
  installId: String_187;
  provider?: String_188;
}
 ...
 */
export type Array_24 = (Object_37 & Object_38)[];

export interface DECO_INTEGRATIONS_SEARCHOutput {
  integrations: Array_24;
}
...
export type String_207 = "day" | "week" | "month";
...
export type Array_26 = Object_40[];
...
export interface Object_40 {
  ...
  label: String_210;
  total: Number_45;
  transactions: Array_27;
}
export interface Object_41 {
  id: String_211;
  timestamp: String_212;
  amount: Number_46;
  agentId: String_213;
  generatedBy: String_214;
}
...
export type String_215 = "day" | "week" | "month" | "year";
...
export type Array_28 = Object_42[];
...
export type String_220 = "day" | "week" | "month";
 ...
 */
export type Array_29 = Object_43[];
 ...
 */
export type Array_30 = String_229[];
/**
 * The id of the app
 */
 ...
 */
export type StringNull = String_235 | Null_74;
...
export interface HOSTING_APP_DEPLOYMENTS_LISTOutput {
  deployments: Array_31;
  app: Object_46;
}
export interface Object_45 {
  id: String_234;
  cloudflare_deployment_id: StringNull;
  entrypoint: String_236;
  created_at: String_237;
  updated_at: String_238;
}
export interface Object_46 {
  id: String_239;
  slug: String_240;
  workspace: String_241;
}
...
export type NumberNull_3 = Number_50 | Null_75;
 ...
 * The workflow runs
 */
export type Array_33 = Object_47[];
...
export interface Object_48 {
  totalRuns: Number_51;
  successCount: Number_52;
  errorCount: Number_53;
  runningCount: Number_54;
  pendingCount: Number_55;
  successRate: Number_56;
...
export interface HOSTING_APP_WORKFLOWS_STATUSInput {
  instanceId: String_252;
  workflowName: String_253;
}
...
export interface HOSTING_APPS_PROMOTEInput {
  deploymentId: String_256;
  routePattern: String_257;
}
...
export interface Object_60 {
  progressToken?: String_275 | Integer;
  [k: string]: unknown;
}
...
export type String_301 = "Channel";
...
export type StringBoolean = String_352 | Boolean_21;
 ...
 */
export type Array_36 = String_356[];
...
export type StringNull_1 = String_370 | Null_86;
 ...
 */
export type Array_39 = String_387[];
/**
 ...
 */
export type Array_40 = String_388[];
...
export type Array_43 = Object_97[];
...
export type Array_45 = Object_108[];
...
export type Array_47 = Object_119[];
...
export type Array_48 = Object_132[];
...
export type Array_50 = Object_137[];
export type Array_49 = Object_136[];
 ...
 * The messages to send to the LLM
 */
export type Array_53 = Object_154[];
/**
 * The URL of the webhook
 */
...
export type Array_52 = Object_151[];
 ...
 * The messages to send to the LLM
 */
export type Array_54 = Object_165[];
/**
 * The URL of the webhook
 */
...
export type BooleanNull = Boolean_43 | Null_92;
...
export type Array_57 = Object_188[];
export type Array_56 = Object_187[];
...
export type Array_58 = Object_192[];
export type String_700 = string;
export type Array_59 = String_700[];
 ...
 */
export type Array_60 = Object_193[];
...
export type Array_61 = Object_196[];
export type String_708 = string;
export type Array_62 = String_708[];
...
export const StateSchema = z.object({
  ...
  SEND_EMAIL_CONTRACT: z.object({
    value: z.string(),
    __type: z.literal("@deco/contracts").default("@deco/contracts"),
  }),
});
...
export const Scopes = {
  ...
  SEND_EMAIL_CONTRACT: {
    CONTRACT_AUTHORIZE: "SEND_EMAIL_CONTRACT::CONTRACT_AUTHORIZE",
    CONTRACT_SETTLE: "SEND_EMAIL_CONTRACT::CONTRACT_SETTLE",
    DECO_CHAT_OAUTH_START: "SEND_EMAIL_CONTRACT::DECO_CHAT_OAUTH_START",
  },
};
